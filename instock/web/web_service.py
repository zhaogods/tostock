...
class Application(tornado.web.Application):
    def __init__(self):
        ...
        handlers = [
            ...
            (r"/instock/console/api/pipeline", consoleHandler.ConsolePipelineApiHandler),
            ...
            (r"/instock/console/api/schedule/preview", consoleHandler.ConsoleSchedulePreviewApiHandler),
            (r"/instock/console/api/schedule", consoleHandler.ConsoleScheduleApiHandler),
            (r"/instock/console/api/notice/ack", consoleHandler.ConsoleNoticeAckApiHandler),
            (r"/instock/console/api/notice/ack_all", consoleHandler.ConsoleNoticeAckAllApiHandler),
            # 数据资产管理。
