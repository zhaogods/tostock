...
TABLE_SYSTEM_TASK_RUN = {'name': 'system_task_run', 'cn': '系统任务运行记录',
                         'columns': {'run_id': {'type': VARCHAR(64, _COLLATE), 'cn': '运行ID', 'size': 180},
                                     ...
                                     'trade_date': {'type': DATE, 'cn': '交易日期', 'size': 110},
                                     'pipeline_run_id': {'type': VARCHAR(64, _COLLATE), 'cn': '管线运行ID', 'size': 180},
                                     'parent_run_id': {'type': VARCHAR(64, _COLLATE), 'cn': '父运行ID', 'size': 180},
                                     'attempt': {'type': SmallInteger, 'cn': '尝试次数', 'size': 80},
                                     'skip_reason': {'type': VARCHAR(500, _COLLATE), 'cn': '跳过原因', 'size': 220},
